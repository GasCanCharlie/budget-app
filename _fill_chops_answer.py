"""
Chops Handy Works LLC ROS — Answer and Cross-Claim
2CCV-26-0000069 | Served 5/22/2026 at 9:45 AM
304 Front Street, Lahaina HI 96761 — Brendan Charles Pelzer, Registered Agent

Long doc title spans all 5 underline rows; drawn manually.
"""
import os
...
CASE = {
    ...
    'output_name':   'Chops_Answer_ROS_FINAL.pdf',
    'ack_header_y':  None,
}

# Doc title pre-split across 5 underline rows.
# Line 1 starts at x=165 (after DOCUMENTS SERVED: label); lines 2-5 at x=46 (left margin).
ANSWER_DOC_LINES = [
    (165, "1. Defendant State of Hawai'i's Answer to Plaintiff 'Ohana Kimokeo's"),
    (46,  "Complaint Filed March 2, 2026 [Dkt. 1]; Defendant State of Hawai'i's Cross-Claim"),
    (46,  "Against Defendants William Brian Acason; Brendan Charles Pelzer;"),
    (46,  "Chop's Handy Works LLC; John and Jane Does 1-100; Doe Corporations 1-100;"),
    (46,  "and Doe Entities 1-100"),
]
...
def main():
    ...
    # Doc title is too long for one line — draw pre-split lines at exact underline y-coords
    underlines_y = [306.1, 318.6, 330.6, 342.6, 354.6]
    page1 = doc[0]
    for i, (x, txt) in enumerate(ANSWER_DOC_LINES):
