              ...
              >
                {selectedFile ? (
                  ...
                  <>
                    ...
                    <p style={{ margin: 0, ...S.muted(14) }}>Drop a CSV, OFX, QIF, or PDF file here, or click to browse</p>
                  </>
                )}
                <input ref={fileRef} type="file" accept=".csv,.ofx,.qfx,.qbo,.qif,.pdf" style={{ display: 'none' }} onChange={e => { const f = e.target.files?.[0]; if (f) setSelectedFile(f) }} />
              </div>
