...
const PERSONALITY_IMAGES: Partial<Record<string, { src: string; dotColor: string }>> = {
  ...
  morning_stack:          { src: '/personalities/morning_stack.webp',          dotColor: '#f59e0b' },
  health_nut:             { src: '/personalities/health_nut.webp',             dotColor: '#10b981' },
  friday_flush:           { src: '/personalities/friday_flush.webp',           dotColor: '#f43f5e' },
  fork_and_knife:         { src: '/personalities/fork_and_knife.webp',         dotColor: '#f97316' },
  home_economist:         { src: '/personalities/home_economist.webp',         dotColor: '#34d399' },
  frequent_flyer:         { src: '/personalities/frequent_flyer.webp',         dotColor: '#818cf8' },
  nest_builder:           { src: '/personalities/nest_builder.webp',           dotColor: '#34d399' },
  night_owl:              { src: '/personalities/night_owl.webp',              dotColor: '#818cf8' },
  digital_native:         { src: '/personalities/digital_native.webp',         dotColor: '#06b6d4' },
  heaven_sent:            { src: '/personalities/heaven_sent.webp',            dotColor: '#a855f7' },
  personal_cfo:           { src: '/personalities/personal_cfo.webp',           dotColor: '#0ea5e9' },
