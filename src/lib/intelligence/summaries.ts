...
const CATEGORY_STYLES: Record<string, { color: string; icon: string; isIncome: boolean }> = {
  ...
  'Housing':         { color: '#6366f1', icon: 'Home',            isIncome: false },
  ...
  'Subscriptions':   { color: '#8b5cf6', icon: 'CreditCard',      isIncome: false },
  'Personal Care':   { color: '#f472b6', icon: 'Scissors',        isIncome: false },
  'Education':       { color: '#0ea5e9', icon: 'BookOpen',        isIncome: false },
  ...
  'Gifts & Charity': { color: '#f43f5e', icon: 'Gift',            isIncome: false },
