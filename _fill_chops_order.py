"""
Chops Handy Works LLC ROS — Order Regarding Interim Site Protection
...
CASE = {
    ...
    'docs': [
        "Order Regarding Interim Site Protection",
    ],
    ...
    'output_name':   'Chops_Order_ROS_FINAL.pdf',
    'ack_header_y':  None,
}
...
def main():
    ...
    for i, txt in enumerate(CASE['docs']):
        ...
        page1.insert_text((x, y), sanitize(f'{i+1}. {txt}'),
